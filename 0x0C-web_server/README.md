# Web server
Project done during **Full Stack Software Engineering Program** at **ALX Africa **. It aims to learn about the roles of web servers and their processes (parent and child), and DNS roles.
